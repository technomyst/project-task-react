...
const ModalNewProjectTask=({CreateEditMode,isOpen,onClose,onSubmitFunc,showM,toggleShow,passedTask,projectId})=>{
    ...
    useEffect(()=>{
        if (CreateEditMode==='Edit' && passedTask!==undefined)
        {
            console.log(CreateEditMode);
            setProjectTaskName(passedTask.name);
            setProjectTaskDescription(passedTask.description);
            setProjectTask(passedTask)
        }
        },[passedTask])
...
export default ModalNewProjectTask;